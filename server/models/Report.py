...
class Report(db.Model):
    ...
    def __init__(self, name, report_type, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path):
        self.name = name
...
class User_Donations_Report(Report):
    ...
    def __init__(self, name, start_date, end_date, generated_by, generated_at, filtered_by, data, file_path):
        super().__init__(name, ReportType.USER_DONATIONS, start_date, end_date, generated_by, generated_at, None, filtered_by, data, file_path)
...
class Shelter_Donations_Report(Report):
    ...
    def __init__(self, name, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path):
        super().__init__(name, ReportType.SHELTER_DONATIONS, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path)
...
class Shelter_Summary_Report(Report):
    ...
    def __init__(self, name, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path):
        super().__init__(name, ReportType.SHELTER_SUMMARY, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path)
...
class Shelter_Resources_Report(Report):
    ...
    def __init__(self, name, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path):
        super().__init__(name, ReportType.SHELTER_RESOURCES, start_date, end_date, generated_by, generated_at, shelter_id, filtered_by, data, file_path)